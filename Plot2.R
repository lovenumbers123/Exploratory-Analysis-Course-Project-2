...
> ## Plot 2 - Show if total  PM2.5 emissions decreased in Baltimore City,  Maryland
> 
...
> png('plot2.png')
> 
> x2 <- barplot(height=Baltimore$Emissions/1000, names.arg=Baltimore$year, xlab="Years", ylab="Total Emissions", ylim=c(0,4), main="Total PM2.5 Emissions in Balitmore City, Maryland")
> 
> dev.off()
null device 
          1 
